        ...
        config_schema={
            ...
            "properties": {
                ...
                "BOOKSTACK_TOKEN_ID": {
                    ...
                    "label": "Token ID",
                    "placeholder": "e.g. 12",
                    "help": "BookStack: your profile picture > API Tokens. The numeric ID shown next to the token (leave blank when editing to keep the current token).",
                    "required": True,
                },
                "BOOKSTACK_TOKEN_SECRET": {
                    "type": "password",
                    "label": "Token Secret",
                    "placeholder": "the long secret string",
                    "help": "The secret shown once when you create the token (leave blank when editing to keep the current token).",
                    "required": True,
                },
            },
            "required": ["BOOKSTACK_URL", "BOOKSTACK_TOKEN_ID", "BOOKSTACK_TOKEN_SECRET"],
        },
